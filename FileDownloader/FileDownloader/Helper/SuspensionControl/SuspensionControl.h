...
@property (nonatomic, assign) BOOL isOnce;
@property (nonatomic, copy) void (^ _Nullable menuBarClickBlock)(NSInteger index, MenuBarHypotenuseItem *item);
@property (nonatomic, copy) void (^ _Nullable moreButtonClickBlock)(NSInteger index, MenuBarHypotenuseItem *item);
